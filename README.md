...
Version `1.0.6` removes unnecessary mandatory Android, Flutter, and Dart plugin dependencies so the plugin can verify cleanly against IntelliJ IDEA 2026.1.
